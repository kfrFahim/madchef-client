    ...
    <div className="mx-14">
      ...
      <div className="all-blogs">
        <div className="border-2 my-3 p-5">
          ...
          <p>
            The most succinct way to explain it is that a controlled input’s
            state is externally passed to it via props, whereas an uncontrolled
            input's state is managed internally. For example, an uncontrolled
            text input's contents can only be changed by the user's input,
            whereas a controlled text input's contents will always be equal to
            one of it's props.
          </p>
        </div>
        ...
        <div className="border-2 my-3 p-5">
          ...
          <p>
            ...
            <ul className="list-disc">
              ...
              <li>
                The above PropTypes can be used while building a react
                application.
              </li>
            </ul>
          </p>
        ...
        <div className="border-2 my-3 p-5">
          ...
          <p>
            In React, a custom hook is a reusable piece of logic that can be
            shared across multiple components. Custom hooks allow you to extract
            complex logic from your components, making them easier to read and
            maintain. They also enable you to abstract away certain concerns and
            provide a cleaner, more concise API for your components to use.
          </p>
        </div>
      </div>
